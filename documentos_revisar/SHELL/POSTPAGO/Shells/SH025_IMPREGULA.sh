...
do
	...
	pMessage "Se ejecuta el procedimiento PKG_CC_PROCACUMULA.ADMPSI_REGULPTO"	
...
$PCLUB_OW.PKG_CC_PROCACUMULA.ADMPSI_REGULPTO(v_fecha,v_coderr,v_deserr,v_regtot,v_regpro,v_regerr);
...
pMessage "Ejecución de SP fue satisfactorio"
	...
	pMessage "Se ejecuta el procedimiento PKG_CC_PROCACUMULA.ADMPSI_EREGULPTO"
...
$PCLUB_OW.PKG_CC_PROCACUMULA.ADMPSI_EREGULPTO(v_fecha,C_CURSOR);
