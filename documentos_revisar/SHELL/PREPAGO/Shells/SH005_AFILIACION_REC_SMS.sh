#!/bin/sh -x
#********************************************************************************************************************
#Programa        : SH005_AFILIACION_REC_SMS
#Descripción     : Envío de mensaje a los Clientes que fueron Registrados en CLAROCLUB por sus Recargas Acumuladas
...
PREF_SHELL="SH005_"
NOMB_SHELL="AFILIACION_REC_SMS"
DESC_PROCESO="Envío de mensajes por Registro Automático por Recargas Acumuladas"
ASUN_MAIL="ERROR: $DESC_PROCESO"
SLDO_MAIL="\n\nPor favor atender este inconveniente. \nGracias"
FLAG_PROCESO="RECARGAS"
NOMB_ARCH="AFIL_RECARGA"
EXTE_ARCH=".CCL"
IDEN_MENSAJE="MSJAFILIACIONCC"
...
$PCLUB_OW.PKG_CC_ENVIO_SMS.ADMPSU_IMP_BLACKLIST('$FLAG_PROCESO','','$NOMARCH','$USER_PROC',V_TOTAL,V_CODERROR,V_DESCERROR);
...
$PCLUB_OW.PKG_CC_ENVIO_SMS.ADMPSS_OBTENER_TELEF_SMS('$FLAG_PROCESO','$CANTREG','','$NOMBARCH',V_CUR_LINEA,V_CODERROR,V_DESCERROR);
...
$PCLUB_OW.PKG_CC_ENVIO_SMS.ADMPSU_IMP_ESTADOSMS('$FLAG_PROCESO',$CANTREG,'','$NOMBARCH','$USER_PROC',V_CODERROR,V_DESCERROR);
