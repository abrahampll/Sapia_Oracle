...
33|VENCIMIENTO DE PUNTO PREPAGO|PKG_CC_PREPAGO|ADMPSI_PREVENCPTO_CARGA|SH006_DESAFILIACION_NOREC.sh  || ADMPSI_PREVENCPTO
58|CAMBIO TITULARIDAD HFC|PKG_CC_PTOSFIJA|ADMPSI_CAMBTIT|SH006_PROC_CAMBTITU
