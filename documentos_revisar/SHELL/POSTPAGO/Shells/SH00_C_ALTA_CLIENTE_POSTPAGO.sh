...
FILE_PATRO="BONUS_ALTA_CLIENTES_"
...
GENERAR_FILE(){
 ...
 do
		...
		NOMBREFILE=$FILE
		echo "3|2|ALTAS POSTPAPGO Y CONTROL|$CODCLIENTE|$DNICLIENTE|||$FECREG|$NOMBREFILE" >> $FILETEMP
 done < $FILEDATA
...
sh -x /home/usrclaroclub/CLAROCLUB/Interno/Postpago/Shells/SH00_C_ALTA_CLIENTE_PREPAGO.sh
