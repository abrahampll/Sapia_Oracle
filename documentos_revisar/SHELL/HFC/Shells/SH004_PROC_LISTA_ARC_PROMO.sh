#! /bin/ksh
#*************************************************************
#* DESCRIPCION           : Recorre Directorio Promocion HFC
#* EJECUCION             : Control-D                            
#* AUTOR                 :                                   
#* FECHA                 : 04/07/2012   VERSION : v1.0       
#* FECHA MOD .           :                         
#*************************************************************
...
FARCH=`date +%Y%m%d`
FILELOG=$DIRLOGHFC/SH004_PROC_LISTA_ARC_PROMO_$FARCH.log
...
$PCLUB_OW.PKG_CC_PTOSFIJA.ADMPSI_EPROMDTH_HFC('7',v_fecha,c_cod_error,c_msje_error,cursorpago);
