...
#Descripción     : Entrega de bono por fidelidad 6M 
...
$PCLUB_OW.PKG_CC_BONOS.ADMPSI_ENTR_BONOFID6M('$NOMBARCH','$BONO','$USER_PROC',V_NUMREGTOT,V_NUMREGVAL,V_NUMREGERR,V_CODERROR,V_DESCERROR);
